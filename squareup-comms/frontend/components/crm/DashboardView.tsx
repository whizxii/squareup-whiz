...
import { MorningBriefingView } from "@/components/crm/MorningBriefingView";
...
export function DashboardView() {
  const [dashMode, setDashMode] = useState<"briefing" | "metrics">("briefing");
  ...
  return (
    <div className="flex-1 overflow-auto">
      <div className="max-w-7xl mx-auto p-6 space-y-6">
        ...
        {dashMode === "briefing" && <MorningBriefingView />}
